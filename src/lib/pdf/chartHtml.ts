...
export function generateChartHTML(chart: ChartOutput, branding?: Branding): string {
  ...
  const brandLogo = branding?.brandLogo ? `<img src="${branding.brandLogo}" style="height:50px">` : ICONS.brandIcon
